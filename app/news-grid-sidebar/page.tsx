                                    ...
                                    <div className="row">
                                            ...
                                            <div className="card-blog-7">
                                                <div className="card-image">
                                                    <Link href="/news-details">
                                                        <img src="/assets/imgs/pages/blog/blog.png" alt="Vatech" />
                                                    </Link>
                                                </div>
                                        ...
                                        <div className="col-lg-6 col-md-6">
                                            <div className="card-blog-7">
                                                <div className="card-image">
                                                    <Link href="/news-details">
                                                        <img src="/assets/imgs/pages/blog/blog2.png" alt="Vatech" />
                                                    </Link>
                                                </div>
                                                <div className="card-info">
                                                    <div className="text-end mb-2">
                                                    ...
                                                    <Link href="/news-details" className="heading-md">
                                                        Future-Proof Your Business with Cutting-Edge IT Solutions
                                                    </Link>
                                                    <Link href="/news-details" className="link-more button-ag-bold">
                                                        Discover More
                                                        <svg width={12} height={12} viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div className="col-lg-6 col-md-6">
                                            <div className="card-blog-7">
                                                <div className="card-image">
                                                    <Link href="/news-details">
                                                        <img src="/assets/imgs/pages/blog/blog4.png" alt="Vatech" />
                                                    </Link>
                                                </div>
                                                <div className="card-info">
                                                    <div className="text-end mb-2">
                                        ...
                                        <div className="col-lg-6 col-md-6">
                                            <div className="card-blog-7">
                                                <div className="card-image">
                                                    <Link href="/news-details">
                                                        <img src="/assets/imgs/pages/blog/blog5.png" alt="Vatech" />
                                                    </Link>
                                                </div>
                                                <div className="card-info">
                                                    <div className="text-end mb-2">
                                                    ...
                                                    <Link href="/news-details" className="heading-md">
                                                        Boosting Efficiency with Tailored IT Solutions
                                                    </Link>
                                                    <Link href="/news-details" className="link-more button-ag-bold">
                                                        Discover More
                                                        <svg width={12} height={12} viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div className="col-lg-6 col-md-6">
                                            <div className="card-blog-7">
                                                <div className="card-image">
                                                    <Link href="/news-details">
                                                        <img src="/assets/imgs/pages/blog/blog7.png" alt="Vatech" />
                                                    </Link>
                                                </div>
                                                <div className="card-info">
                                                    <div className="text-end mb-2">
                                                    ...
                                                    <Link href="/news-details" className="heading-md">
                                                        The Key to Business Growth: Scalable IT Infrastructure
                                                    </Link>
                                                    <Link href="/news-details" className="link-more button-ag-bold">
                                                        Discover More
                                                        <svg width={12} height={12} viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div className="col-lg-6 col-md-6">
                                            <div className="card-blog-7">
                                                <div className="card-image">
                                                    <Link href="/news-details">
                                                        <img src="/assets/imgs/pages/blog/blog8.png" alt="Vatech" />
                                                    </Link>
                                                </div>
                                                <div className="card-info">
                                                    <div className="text-end mb-2">
                            ...
                            <div className="blog-content-right">
                                        ...
                                        <li>
                                            ...
                                            <div className="news-info">
                                                <div className="news-postdate">
                                                    ...
                                                    <span className="paragraph-rubik-r-sm">August 17, 2026</span>
                                                </div>
                                                <Link href="/news-details" className="sub-heading-ag-lg news-link">
                                ...
                                <div className="sidebar-border border-10 bdr-5 p-4 mb-4">
                                    ...
                                    <div className="content-sidebar">
                                        <ul>
                                            <li>
                                                <Link href="/news-grid-sidebar">
                                                    &gt; Agency News <span>(10)</span>
                                                </Link>
                                            </li>
                                            <li>
                                                <Link href="/news-grid-sidebar">
                                                    &gt; Digital Marketing <span>(18)</span>
                                                </Link>
                                            </li>
                                            <li>
                                                <Link href="/news-grid-sidebar">
                                                    &gt; Information Technology <span>(15)</span>
                                                </Link>
                                            </li>
                                            <li>
                                                <Link href="/news-grid-sidebar">
                                                    &gt; New Ideas <span>(13)</span>
                                                </Link>
                                            </li>
                                            <li>
                                                <Link href="/news-grid-sidebar">
                                                    &gt; Marketing &amp; Branding <span>(12)</span>
                                                </Link>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div className="sidebar-border border-10 bdr-5 p-4 mb-4">
                                    ...
                                    <div className="content-sidebar">
                                        <Link href="/news-grid-sidebar" className="btn btn-tag me-2 mb-2">
                                            Design
                                        </Link>
                                        <Link href="/news-grid-sidebar" className="btn btn-tag me-2 mb-2">
                                            Development
